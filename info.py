...
PICS = (environ.get('PICS', 'https://envs.sh/E-p.jpg')).split()  # Sample pic
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002376137081').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002376137081').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002602055892'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/HowtoDowlnoad/24')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '89ff7ed9d4b4aaaf7a7158a590043d3cd02ae488')
